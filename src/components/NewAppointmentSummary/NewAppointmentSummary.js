...
const NewAppointmentSummary = (props) => {
  return (
    <section className="NewAppointmentSummary">
      ...
      <p>
        Dear {props.username}, <br />
        <br /> Your appointment regarding {props.task} has been made at{' '}
        {props.appointmentTime} {props.date}.
      </p>
      {props.message && (
        <p className="sub-p">
          <br />
          The additional information: {props.message}
        </p>
      )}
      ...
      <div className="row">
        <div className="col-sm-4">
          <Button
            ...
            clicked={props.appointmentCancelled}
          >
            CANCEL
          </Button>
        </div>
        ...
        <div className="col-sm-4">
          <Button
            ...
            clicked={props.appointmentContinued}
          >
            CONTINUE
          </Button>
        </div>
